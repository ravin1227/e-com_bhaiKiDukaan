<?php
    ...
    function get_product($con,$limit='',$cat_id='',$product_id='',$search_str='',$is_best_seller=''){
    ...
    function sentInvoice($con,$order_id){
        ...
        $user_order=mysqli_fetch_assoc(mysqli_query($con,"select `order`.*,users.email  from `order`,users where users.id=`order`.user_id and `order`.id='$order_id'"));
        ...
        <body>
                    ...
                    <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <div class="f-fallback">
                                ...
                                <p>Thanks for using <strong><a href="bhaikidukaan.com">Bhai Ki Dukaan</a></strong>. This is an invoice for your recent purchase.</p>
            ...
            $mail->SMTPSecure="tls";
            $mail->SMTPAuth=true;
            $mail->Username="revan.121022@gmail.com";
            $mail->Password="@qwertyuiop@";
            $mail->SetFrom("revan.121022@gmail.com");
